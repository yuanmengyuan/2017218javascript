    ...
    var Form = (0, _createReactClass2['default'])({
      ...
      getFieldDecorator: function getFieldDecorator(name, fieldOption) {
        ...
        return function (fieldElem) {
          ...
          return _react2['default'].cloneElement(fieldElem, (0, _extends3['default'])({}, props, _this.fieldsStore.getFieldValuePropValue(fieldMeta)));
        };
      },
      ...
      validateFieldsInternal: function validateFieldsInternal(fields, _ref, callback) {
        ...
        validator.validate(allValues, options, function (errors) {
          ...
          if (callback) {
            ...
            callback((0, _utils.isEmptyObject)(errorsGroup) ? null : errorsGroup, _this4.fieldsStore.getFieldsValue((0, _utils.flatFieldNames)(fieldNames)));
          }
        });
      },
